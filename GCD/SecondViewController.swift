...
//  GCD
//
//  Created by Василий Метлин on 08.03.2022.
//
...
class SecondViewController: UIViewController {
    ...
    fileprivate func loginAlert() {
        let alertController = UIAlertController(title: "Registered?", message: "Enter your login and password", preferredStyle: .alert)
